...
namespace prjJJM.ViewModels
{
    public class CClassViewModel
    {
        ...
        public CClassViewModel(tClass c)
        {
            _class = c;
        }
        ...
        [DisplayName("課程副標")]
        [Required(ErrorMessage = "請輸入課程副標")] /*後端驗證*/
        public string c_nameText { get { return _class.c_nameText; } set { _class.c_nameText = value; } }
        [DisplayName("課程簡介")]
        [Required(ErrorMessage = "請輸入課程簡介")] /*後端驗證*/
        public string c_intro { get { return _class.c_intro; } set { _class.c_intro = value; } }
        [DisplayName("開課時間")]
        [Required(ErrorMessage = "請輸入開課時間")] /*後端驗證*/
        [DisplayFormat(DataFormatString = "{0:yyyy/MM/dd}", ApplyFormatInEditMode = true)]
        public Nullable<System.DateTime> c_startTime { get { return _class.c_startTime; } set { _class.c_startTime = value; } }
        [DisplayName("完課時間")]
        [Required(ErrorMessage = "請輸入完課時間")] /*後端驗證*/
        [DisplayFormat(DataFormatString = "{0:yyyy/MM/dd}", ApplyFormatInEditMode = true)]
        public Nullable<System.DateTime> c_endTime { get { return _class.c_endTime; } set { _class.c_endTime = value; } }
        [DisplayName("課程時數")]
        [Required(ErrorMessage = "請輸入課程時數")] /*後端驗證*/
        public Nullable<int> c_hourRate { get { return _class.c_hourRate; } set { _class.c_hourRate = value; } }
        [DisplayName("開始報名時間")]
        [Required(ErrorMessage = "請輸入開始報名時間")] /*後端驗證*/
        [DisplayFormat(DataFormatString = "{0:yyyy/MM/dd}", ApplyFormatInEditMode = true)]
        public Nullable<System.DateTime> c_registerStart { get { return _class.c_registerStart; } set { _class.c_registerStart = value; } }
        [DisplayName("報名結束時間")]
        [Required(ErrorMessage = "請輸入報名結束時間")] /*後端驗證*/
        [DisplayFormat(DataFormatString = "{0:yyyy/MM/dd}", ApplyFormatInEditMode = true)]
        public Nullable<System.DateTime> c_registerEnd { get { return _class.c_registerEnd; } set { _class.c_registerEnd = value; } }
        [DisplayName("課程人數上限")]
        [Required(ErrorMessage = "請輸入課程人數上限")] /*後端驗證*/
        public Nullable<int> c_maxStudent { get { return _class.c_maxStudent; } set { _class.c_maxStudent = value; } }
        [DisplayName("最少招生人數")]
        [Required(ErrorMessage = "請輸入最少招生人數")] /*後端驗證*/
        ...
        [DisplayName("教室位置")]
        [Required(ErrorMessage = "請輸入教室位置")] /*後端驗證*/
        ...
        [DisplayName("優惠開始時間")]
        [DisplayFormat(DataFormatString = "{0:yyyy/MM/dd}", ApplyFormatInEditMode = true)]
        public Nullable<System.DateTime> c_onsaleStart { get { return _class.c_onsaleStart; } set { _class.c_onsaleStart = value; } }
        [DisplayName("優惠結束時間")]
        [DisplayFormat(DataFormatString = "{0:yyyy/MM/dd}", ApplyFormatInEditMode = true)]
        public Nullable<System.DateTime> c_onsaleEnd { get { return _class.c_onsaleEnd; } set { _class.c_onsaleEnd = value; } }
        [DisplayName("優惠價格")]
        public Nullable<int> c_discount { get { return _class.c_discount; } set { _class.c_discount = value; } }
        [DisplayName("課程分級")]
        [Required(ErrorMessage = "請輸入課程分級")] /*後端驗證*/
        public string c_level { get { return _class.c_level; } set { _class.c_level = value; } }
        [DisplayName("上課基本要求")]
        [Required(ErrorMessage = "請輸入上課基本要求")] /*後端驗證*/
